...
**Primary**
```
Swift · SwiftUI · UIKit · Combine · MVVM · VIPER · Redux/UDF
```

**Mobile**
```
HealthKit · CoreBluetooth · CoreData · ARKit · WatchKit · AVFoundation
```

**Cross-Platform & Android**
```
Flutter (Dart) · React Native · Kotlin · Jetpack Compose
```

**AI & ML**
```
OpenAI / ChatGPT API · Core ML · Firebase ML Kit · GitHub Copilot
```

**DevOps & QA**
```
Fastlane · Jenkins · Bitrise · TestFlight · Firebase Crashlytics · XCTest
```
...
2018 – 2019     →  Senior iOS Developer, Wegile
2013 – 2018     →  iOS Engineer, Seasia Infotech / Code Optimal Solutions
```
...
<div align="center">
<sub>US Citizen · No Sponsorship Required · Open to senior/staff contracts & full-time</sub>
</div>
